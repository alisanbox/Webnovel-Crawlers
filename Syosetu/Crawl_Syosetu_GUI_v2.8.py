# =====================================================
#       SYOSETU.COM NOVEL CRAWLER — GUI VERSION 2.8
#               © Credit: Ali Santoso
# =====================================================
...
def parse_novel_info(html, domain_type):
    ...
    if m:
        ...
        patterns_author = [
            r'class="p-novel__author-name"[^>]*><a[^>]*href="(https://xmypage\.syosetu\.com/[^"]+)"[^>]*>([^<]+)</a>',
        ]
    ...
    m = re.search(r'href="(https://xmypage\.syosetu\.com/[^"]+)"', html, re.I)
...
class SyosetuCrawlerGUI:
    def __init__(self, root):
        ...
        self.root.title("Syosetu Crawler v2.8 — by Ali Santoso")
        ...
        self.info_text = tk.Text(f_info, height=10, wrap="word", state="disabled")
        ...
        write_log("Syosetu Crawler v2.8 — URL at TOP of Synopsis ✅")
